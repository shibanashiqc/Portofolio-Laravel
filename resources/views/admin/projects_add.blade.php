...
@section('content')
 ...
 <div class="content-wrapper">
  ...
  <div class="card card-primary">
    ...
    <form enctype="multipart/form-data" method="POST" action="{{ route('projects.add') }}">
        @csrf
      <div class="card-body">
     ...
     @enderror
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="repo_url" placeholder="https://github.com/shibanashiq/example">
            @error('repo_url')
        <span > {{ $message }}</span>
     @enderror
        </div>
     ...
     @enderror
        ...
        <div class="form-group">
            ...
            <input type="file" id="photo" name="photo" style="background-color: #fff;" class="form-control" placeholder="Choose File">
            @error('photo')
                  <span>{{ $message }}</span>
                  @enderror
          </div>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="lang" placeholder="PHP,LARAVEL,JAVASCRIPT">
            @error('lang')
        <span > {{ $message }}</span>
     @enderror
        </div>
